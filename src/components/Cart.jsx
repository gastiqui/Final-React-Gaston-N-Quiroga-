            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                        <div className="alert alert-warning text-center" role="alert">No se encontró ningún producto en el carrito.</div>
                    </div>
                </div>
            </div>
        )
            ...
            <div className="row">
                ...
                <div className="col-md-12">
                    <table className="table">
                        <tr>
                            <td className="text-end" colSpan={5}><Link className="btn btn-warning bg-warning" onClick={() => { clear() }}>Vaciar el carrito</Link></td>
                        </tr>
                        {
                            cart.map(item => (
                                <tr key={item.index}>
